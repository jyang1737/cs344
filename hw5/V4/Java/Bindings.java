...
public class Bindings {
    ...
    private final List<Binding> bindingList;
    ...
    public Bindings (List< String > idList, List<Val> valList) {
        ...
        while (is.hasNext()) {
            bindingList.add(new Binding( is.next(), vs.next()));
        }
    }
    ...
    /**
     * Add a new Binding object to this local environment.
     */
    ...
    /**
     * Add a binding (id, val) to this local environment.
     */
    public void add( String id, Val val ) {
        add(new Binding(id, val));
    }
